...
/**
 * Esta clase contiene a la base de datos de los juegos del play station
 *
...
public class BasePlay {
    ...
    public void guardarEnArchivos(Juegos j) {
        try {
            ...
            BufferedWriter bw = new BufferedWriter(new FileWriter("juegosPlay.txt", true));
    ...
    public boolean existeDentroDeLaBase(String juego) {
        for (Object lista : datosJuegosPlay()) {
    ...
    public String dameMonto(String juego) {
        String[] arreglo = new String[datosJuegosPlay().length];
        String monto = "";
        arreglo = datosJuegosPlay();
